...
import xanthan.mpocketkeypad.GlobalState;
...
public class MpockMqClient implements MqttCallback {
    ...
    public MpockMqClient(String userNameL, Context contextL)
        ...
        appVar = (GlobalState) vars.context.getApplicationContext();
...
//                    }
    ...
    public void connectionLost(Throwable cause) {
        ...
        //SET APP VAR
        appVar.connectionStatus = Globals.DISCONNECTED;
    }
    ...
    public void deliveryComplete(IMqttDeliveryToken token) {
        ...
        //SET SINGLETON VARS
        appVar.connectionStatus = Globals.CONNECTED;
...
//        }
    ...
    public void messageArrived(String topic, MqttMessage message) throws Exception {
        ...
        try {
            //PROCESS MESSAGE...
            if (topic.endsWith("/"+Globals.NEW_STUDENT_CHARGE)) {
            ...
            }else  if (topic.endsWith("/"+Globals.STUDENT_CHARGE_FINISHED)) {
                log("topic.endsWith Globals.STUDENT_CHARGE_FINISHED");
                String daMessage = new String(message.getPayload());
                log("daMessage:" + daMessage);

                //GET NEW STUDENT CHARGE OBJECT
                log("posting STUDENT_CHARGE_FINISHED");
                StudentChargeFinished studentChargeFinished = vars.gson.fromJson(daMessage, StudentChargeFinished.class);
                log("got STUDENT_CHARGE_FINISHED result:"+ studentChargeFinished.studentCharge.transResult);
                log("got transId:"+ studentChargeFinished.studentCharge.transId);
                EventBus.getDefault().post(studentChargeFinished);
